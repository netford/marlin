...
//if(!is_logged())
//{
//      set_flash_message("red", "Не залогинен или сессия устарела.");
//     redirect_to("login");
//}
if (!is_admin())
{
...
if(isset($_POST["name"]) && isset($_POST["email"]) && isset($_POST["password"])) {
    ...
    if(is_user_registered($_POST["email"]))
    {
        set_flash_message("red", "Пользователь уже зарегестрирован");
        redirect_to("users");
    }

    add_user();
    set_flash_message("green", "Пользователь добавлен");
    redirect_to("users");
// функция add_user() полностью переписана, т.к. много параметров входящий за один раз
// все параметры берутся из $_POST, поэтому не имеет входящих параметров как в старой версии
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form id="js-create-user-form" novalidate="" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control-file" name="pic">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                        <button class="btn btn-success" id="js-create-user-btn">Добавить</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        {
            $("#js-create-user-btn").click(function(event)
            {

                // Fetch form to apply custom Bootstrap validation
                var form = $("#js-create-user-form");
